...
entity system_v_tpg_0_0_tpgPatternTartanCEe0_rom is 
    generic(
             dwidth     : integer := 3; 
             awidth     : integer := 6; 
             mem_size    : integer := 64
...
architecture rtl of system_v_tpg_0_0_tpgPatternTartanCEe0_rom is 
...
entity system_v_tpg_0_0_tpgPatternTartanCEe0 is
    generic (
        DataWidth : INTEGER := 3;
...
architecture arch of system_v_tpg_0_0_tpgPatternTartanCEe0 is
    component system_v_tpg_0_0_tpgPatternTartanCEe0_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    system_v_tpg_0_0_tpgPatternTartanCEe0_rom_U :  component system_v_tpg_0_0_tpgPatternTartanCEe0_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
